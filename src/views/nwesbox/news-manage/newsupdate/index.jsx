...
export default function NewsUpdate(props) {
    ...
    useEffect(() => {
        axios.get(`http://localhost:8000/news?id=${props.match.params.id}&_expand=category&_expan=role`).then((res) => {
      ...
      <div>
          ...
          <div className="change" style={{ marginTop: "50px" }}>
              ...
              <div className={current === 1 ? "" : "hide"}>
                  <NewsEditor getContent={getContent} content={content?content:""}></NewsEditor>
              </div>
